...
SHELL            := /bin/bash
PROJECT          := github.com/IrisDande/pulumi-squadcast
...
TFGEN            := pulumi-tfgen-squadcast
PROVIDER         := pulumi-resource-squadcast
...
upstream/.git:
	...
	git -c advice.detachedHead=false clone --depth 1 --branch 'v$(PROVIDER_VERSION)' 'https://github.com/SquadcastHub/terraform-provider-squadcast' upstream
