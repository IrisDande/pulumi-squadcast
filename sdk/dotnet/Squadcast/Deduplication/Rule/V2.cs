...
namespace IrisDanded.Pulumi.Squadcast.Deduplication.Rule
{
    /// <summary>
    ...
    ///     });
    /// 
    ///     var exampleDeduplicationRule = new Squadcast.Deduplication.Rule.V2("exampleDeduplicationRule", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var exampleBasicDeduplicationRule = new Squadcast.Deduplication.Rule.V2("exampleBasicDeduplicationRule", new()
    ///     {
    ///         ServiceId = exampleService.Apply(getServiceResult =&gt; getServiceResult.Id),
    ///         IsBasic = true,
    ///         Description = "basic",
    ...
    ///         {
    ///             new Squadcast.Deduplication.Rule.Inputs.V2BasicExpressionArgs
    ///             {
    ///                 Lhs = "payload[\"foo\"]",
    ///                 Op = "is",
    ///                 Rhs = "bar",
    ...
    /// ```
    /// </summary>
    [SquadcastResourceType("squadcast:deduplication/rule/v2:V2")]
    public partial class V2 : global::Pulumi.CustomResource
    {
        ...
        public V2(string name, V2Args args, CustomResourceOptions? options = null)
            : base("squadcast:deduplication/rule/v2:V2", name, args ?? new V2Args(), MakeResourceOptions(options, ""))
        {
        }

        private V2(string name, Input<string> id, V2State? state = null, CustomResourceOptions? options = null)
            : base("squadcast:deduplication/rule/v2:V2", name, state, MakeResourceOptions(options, id))
        {
        }
