...
namespace IrisDanded.Pulumi.Squadcast.DeduplicationRule
{
    /// <summary>
    ...
    ///     });
    /// 
    ///     var exampleDeduplicationRule = new Squadcast.DeduplicationRule.RuleV2("exampleDeduplicationRule", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var exampleBasicDeduplicationRule = new Squadcast.DeduplicationRule.RuleV2("exampleBasicDeduplicationRule", new()
    ///     {
    ///         ServiceId = exampleService.Apply(getServiceResult =&gt; getServiceResult.Id),
    ///         IsBasic = true,
    ///         Description = "basic",
    ...
    ///         {
    ///             new Squadcast.DeduplicationRule.Inputs.RuleV2BasicExpressionArgs
    ///             {
    ///                 Lhs = "payload[\"foo\"]",
    ///                 Op = "is",
    ///                 Rhs = "bar",
    ...
    /// ```
    /// </summary>
    [SquadcastResourceType("squadcast:DeduplicationRule/ruleV2:RuleV2")]
    public partial class RuleV2 : global::Pulumi.CustomResource
    {
        ...
        public RuleV2(string name, RuleV2Args args, CustomResourceOptions? options = null)
            : base("squadcast:DeduplicationRule/ruleV2:RuleV2", name, args ?? new RuleV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private RuleV2(string name, Input<string> id, RuleV2State? state = null, CustomResourceOptions? options = null)
            : base("squadcast:DeduplicationRule/ruleV2:RuleV2", name, state, MakeResourceOptions(options, id))
        {
        }
