...
namespace IrisDanded.Pulumi.Squadcast.Ger.Ruleset
{
    /// <summary>
    ...
    ///     });
    /// 
    ///     var exampleGerRulesetRule = new Squadcast.Ger.Ruleset.Rule("exampleGerRulesetRule", new()
    ///     {
    ///         GerId = exampleGer.Id,
    ...
    /// ```
    /// </summary>
    [SquadcastResourceType("squadcast:ger/ruleset/rule:Rule")]
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("squadcast:ger/ruleset/rule:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, RuleState? state = null, CustomResourceOptions? options = null)
            : base("squadcast:ger/ruleset/rule:Rule", name, state, MakeResourceOptions(options, id))
        {
        }
