...
namespace IrisDanded.Pulumi.Squadcast.Ger.Ruleset.Rules
{
    /// <summary>
    ...
    ///     });
    /// 
    ///     var exampleGerRulesetRule1 = new Squadcast.Ger.Ruleset.Rule("exampleGerRulesetRule1", new()
    ///     {
    ///         GerId = exampleGer.Id,
    ...
    ///     });
    /// 
    ///     var exampleGerRulesetRule2 = new Squadcast.Ger.Ruleset.Rule("exampleGerRulesetRule2", new()
    ///     {
    ///         GerId = exampleGer.Id,
    ///         AlertSource = exampleGerRuleset.AlertSource,
    ...
    ///     });
    /// 
    ///     var ruleOrdering = new Squadcast.Ger.Ruleset.Rules.Ordering("ruleOrdering", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [SquadcastResourceType("squadcast:ger/ruleset/rules/ordering:Ordering")]
    public partial class Ordering : global::Pulumi.CustomResource
    {
        ...
        public Ordering(string name, OrderingArgs args, CustomResourceOptions? options = null)
            : base("squadcast:ger/ruleset/rules/ordering:Ordering", name, args ?? new OrderingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ordering(string name, Input<string> id, OrderingState? state = null, CustomResourceOptions? options = null)
            : base("squadcast:ger/ruleset/rules/ordering:Ordering", name, state, MakeResourceOptions(options, id))
        {
        }
