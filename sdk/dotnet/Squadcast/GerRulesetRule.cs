...
namespace IrisDanded.Pulumi.Squadcast
{
    ...
    /// ```
    /// </summary>
    [SquadcastResourceType("squadcast:index/gerRulesetRule:GerRulesetRule")]
    public partial class GerRulesetRule : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GerRulesetRule(string name, GerRulesetRuleArgs args, CustomResourceOptions? options = null)
            : base("squadcast:index/gerRulesetRule:GerRulesetRule", name, args ?? new GerRulesetRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GerRulesetRule(string name, Input<string> id, GerRulesetRuleState? state = null, CustomResourceOptions? options = null)
            : base("squadcast:index/gerRulesetRule:GerRulesetRule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GerRulesetRule Get(string name, Input<string> id, GerRulesetRuleState? state = null, CustomResourceOptions? options = null)
        {
            return new GerRulesetRule(name, id, state, options);
        }
    }

    public sealed class GerRulesetRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public GerRulesetRuleArgs()
        {
        }
        public static new GerRulesetRuleArgs Empty => new GerRulesetRuleArgs();
    }

    public sealed class GerRulesetRuleState : global::Pulumi.ResourceArgs
    {
        [Input("action")]
        private InputMap<string>? _action;
        ...
        public GerRulesetRuleState()
        {
        }
        public static new GerRulesetRuleState Empty => new GerRulesetRuleState();
    }
}
