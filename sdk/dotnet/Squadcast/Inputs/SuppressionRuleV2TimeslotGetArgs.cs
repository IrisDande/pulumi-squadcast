...
namespace IrisDanded.Pulumi.Squadcast.Inputs
{
    ...
    public sealed class SuppressionRuleV2TimeslotGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("customs")]
        private InputList<Inputs.SuppressionRuleV2TimeslotCustomGetArgs>? _customs;
        ...
        /// </summary>
        public InputList<Inputs.SuppressionRuleV2TimeslotCustomGetArgs> Customs
        {
            get => _customs ?? (_customs = new InputList<Inputs.SuppressionRuleV2TimeslotCustomGetArgs>());
            set => _customs = value;
        }
        ...
        public SuppressionRuleV2TimeslotGetArgs()
        {
        }
        public static new SuppressionRuleV2TimeslotGetArgs Empty => new SuppressionRuleV2TimeslotGetArgs();
    }
}
