...
namespace IrisDanded.Pulumi.Squadcast.Routing
{
    /// <summary>
    ...
    /// ```
    /// </summary>
    [SquadcastResourceType("squadcast:routing/rules:Rules")]
    public partial class Rules : global::Pulumi.CustomResource
    {
        ...
        public Rules(string name, RulesArgs args, CustomResourceOptions? options = null)
            : base("squadcast:routing/rules:Rules", name, args ?? new RulesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rules(string name, Input<string> id, RulesState? state = null, CustomResourceOptions? options = null)
            : base("squadcast:routing/rules:Rules", name, state, MakeResourceOptions(options, id))
        {
        }
