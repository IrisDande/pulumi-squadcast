...
namespace IrisDanded.Pulumi.Squadcast
{
    ...
    /// ```
    /// </summary>
    [SquadcastResourceType("squadcast:index/routingRuleV2:RoutingRuleV2")]
    public partial class RoutingRuleV2 : global::Pulumi.CustomResource
    {
        /// <summary>
        /// The basic expression which needs to be evaluated to be true for this rule to apply.
        /// </summary>
        [Output("basicExpressions")]
        public Output<ImmutableArray<Outputs.RoutingRuleV2BasicExpression>> BasicExpressions { get; private set; } = null!;
        ...
        public RoutingRuleV2(string name, RoutingRuleV2Args args, CustomResourceOptions? options = null)
            : base("squadcast:index/routingRuleV2:RoutingRuleV2", name, args ?? new RoutingRuleV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private RoutingRuleV2(string name, Input<string> id, RoutingRuleV2State? state = null, CustomResourceOptions? options = null)
            : base("squadcast:index/routingRuleV2:RoutingRuleV2", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RoutingRuleV2 Get(string name, Input<string> id, RoutingRuleV2State? state = null, CustomResourceOptions? options = null)
        {
            return new RoutingRuleV2(name, id, state, options);
        }
    }

    public sealed class RoutingRuleV2Args : global::Pulumi.ResourceArgs
    {
        [Input("basicExpressions")]
        private InputList<Inputs.RoutingRuleV2BasicExpressionArgs>? _basicExpressions;

        /// <summary>
        /// The basic expression which needs to be evaluated to be true for this rule to apply.
        /// </summary>
        public InputList<Inputs.RoutingRuleV2BasicExpressionArgs> BasicExpressions
        {
            get => _basicExpressions ?? (_basicExpressions = new InputList<Inputs.RoutingRuleV2BasicExpressionArgs>());
        ...
        public RoutingRuleV2Args()
        {
        }
        public static new RoutingRuleV2Args Empty => new RoutingRuleV2Args();
    }

    public sealed class RoutingRuleV2State : global::Pulumi.ResourceArgs
    {
        [Input("basicExpressions")]
        private InputList<Inputs.RoutingRuleV2BasicExpressionGetArgs>? _basicExpressions;

        /// <summary>
        /// The basic expression which needs to be evaluated to be true for this rule to apply.
        /// </summary>
        public InputList<Inputs.RoutingRuleV2BasicExpressionGetArgs> BasicExpressions
        {
            get => _basicExpressions ?? (_basicExpressions = new InputList<Inputs.RoutingRuleV2BasicExpressionGetArgs>());
            set => _basicExpressions = value;
        }
        ...
        public RoutingRuleV2State()
        {
        }
        public static new RoutingRuleV2State Empty => new RoutingRuleV2State();
    }
}
