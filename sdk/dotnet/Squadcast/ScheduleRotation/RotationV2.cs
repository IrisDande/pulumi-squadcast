...
namespace IrisDanded.Pulumi.Squadcast.ScheduleRotation
{
    /// <summary>
    ...
    ///     var rotationsWithWeeklyPeriod = new Squadcast.ScheduleRotation.RotationV2("rotationsWithWeeklyPeriod", new()
    ///     {
    ...
    ///         ShiftTimeslots = new[]
    ///         {
    ///             new Squadcast.ScheduleRotation.Inputs.RotationV2ShiftTimeslotArgs
    ///             {
    ///                 StartHour = 10,
    ///                 StartMinute = 30,
    ///                 Duration = 720,
    ...
    ///         {
    ///             new Squadcast.ScheduleRotation.Inputs.RotationV2ParticipantGroupArgs
    ///             {
    ///                 Participants = new[]
    ///                 {
    ///                     new Squadcast.ScheduleRotation.Inputs.RotationV2ParticipantGroupParticipantArgs
    ///                     {
    ...
    ///     var rotationsWithCustomPeriod = new Squadcast.ScheduleRotation.RotationV2("rotationsWithCustomPeriod", new()
    ///     {
    ///         ScheduleId = getSchedule.Apply(getV2Result =&gt; getV2Result.Id),
    ...
    /// ```
    /// </summary>
    [SquadcastResourceType("squadcast:ScheduleRotation/rotationV2:RotationV2")]
    public partial class RotationV2 : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.RotationV2ParticipantGroup>> ParticipantGroups { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.RotationV2ShiftTimeslot>> ShiftTimeslots { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a RotationV2 resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public RotationV2(string name, RotationV2Args args, CustomResourceOptions? options = null)
            : base("squadcast:ScheduleRotation/rotationV2:RotationV2", name, args ?? new RotationV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private RotationV2(string name, Input<string> id, RotationV2State? state = null, CustomResourceOptions? options = null)
            : base("squadcast:ScheduleRotation/rotationV2:RotationV2", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RotationV2 Get(string name, Input<string> id, RotationV2State? state = null, CustomResourceOptions? options = null)
        {
            return new RotationV2(name, id, state, options);
        }
    }

    public sealed class RotationV2Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Frequency with which participants change in the rotation.
        /// </summary>
        ...
        private InputList<Inputs.RotationV2ParticipantGroupArgs>? _participantGroups;

        /// <summary>
        /// Ordered list of participant groups for the rotation. For each rotation the participant*groups are cycled through in order.
        /// </summary>
        public InputList<Inputs.RotationV2ParticipantGroupArgs> ParticipantGroups
        {
            get => _participantGroups ?? (_participantGroups = new InputList<Inputs.RotationV2ParticipantGroupArgs>());
        ...
        private InputList<Inputs.RotationV2ShiftTimeslotArgs>? _shiftTimeslots;

        /// <summary>
        /// Timeslots where the rotation is active.
        /// </summary>
        public InputList<Inputs.RotationV2ShiftTimeslotArgs> ShiftTimeslots
        {
            get => _shiftTimeslots ?? (_shiftTimeslots = new InputList<Inputs.RotationV2ShiftTimeslotArgs>());
        ...
        public RotationV2Args()
        {
        }
        public static new RotationV2Args Empty => new RotationV2Args();
    }

    public sealed class RotationV2State : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Frequency with which participants change in the rotation.
        /// </summary>
        ...
        [Input("participantGroups")]
        private InputList<Inputs.RotationV2ParticipantGroupGetArgs>? _participantGroups;

        /// <summary>
        /// Ordered list of participant groups for the rotation. For each rotation the participant*groups are cycled through in order.
        /// </summary>
        public InputList<Inputs.RotationV2ParticipantGroupGetArgs> ParticipantGroups
        {
            get => _participantGroups ?? (_participantGroups = new InputList<Inputs.RotationV2ParticipantGroupGetArgs>());
            set => _participantGroups = value;
        }
        ...
        private InputList<Inputs.RotationV2ShiftTimeslotGetArgs>? _shiftTimeslots;

        /// <summary>
        /// Timeslots where the rotation is active.
        /// </summary>
        public InputList<Inputs.RotationV2ShiftTimeslotGetArgs> ShiftTimeslots
        {
            get => _shiftTimeslots ?? (_shiftTimeslots = new InputList<Inputs.RotationV2ShiftTimeslotGetArgs>());
            set => _shiftTimeslots = value;
        }
        ...
        public RotationV2State()
        {
        }
        public static new RotationV2State Empty => new RotationV2State();
    }
}
