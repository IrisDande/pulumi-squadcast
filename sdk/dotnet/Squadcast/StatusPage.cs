...
namespace IrisDanded.Pulumi.Squadcast
{
    ...
    /// ```
    /// </summary>
    [SquadcastResourceType("squadcast:index/statusPage:StatusPage")]
    public partial class StatusPage : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("owner")]
        public Output<Outputs.StatusPageOwner> Owner { get; private set; } = null!;
        ...
        /// </summary>
        [Output("themeColor")]
        public Output<Outputs.StatusPageThemeColor> ThemeColor { get; private set; } = null!;
        ...
        public StatusPage(string name, StatusPageArgs args, CustomResourceOptions? options = null)
            : base("squadcast:index/statusPage:StatusPage", name, args ?? new StatusPageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StatusPage(string name, Input<string> id, StatusPageState? state = null, CustomResourceOptions? options = null)
            : base("squadcast:index/statusPage:StatusPage", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class StatusPageArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.StatusPageOwnerArgs> Owner { get; set; } = null!;
        ...
        public Input<Inputs.StatusPageThemeColorArgs> ThemeColor { get; set; } = null!;
    ...
    public sealed class StatusPageState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("owner")]
        public Input<Inputs.StatusPageOwnerGetArgs>? Owner { get; set; }
        ...
        /// </summary>
        [Input("themeColor")]
        public Input<Inputs.StatusPageThemeColorGetArgs>? ThemeColor { get; set; }
