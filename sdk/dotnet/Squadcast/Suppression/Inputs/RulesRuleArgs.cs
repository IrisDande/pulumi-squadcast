...
namespace IrisDanded.Pulumi.Squadcast.Suppression.Inputs
{
    ...
    public sealed class RulesRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("timeslots")]
        private InputList<Inputs.RulesRuleTimeslotArgs>? _timeslots;

        /// <summary>
        /// The timeslots for which this rule should be applied.
        /// </summary>
        public InputList<Inputs.RulesRuleTimeslotArgs> Timeslots
        {
            get => _timeslots ?? (_timeslots = new InputList<Inputs.RulesRuleTimeslotArgs>());
