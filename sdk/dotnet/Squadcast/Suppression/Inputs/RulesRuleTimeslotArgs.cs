...
namespace IrisDanded.Pulumi.Squadcast.Suppression.Inputs
{
    ...
    public sealed class RulesRuleTimeslotArgs : global::Pulumi.ResourceArgs
    {
        [Input("customs")]
        private InputList<Inputs.RulesRuleTimeslotCustomArgs>? _customs;
        ...
        /// </summary>
        public InputList<Inputs.RulesRuleTimeslotCustomArgs> Customs
        {
            get => _customs ?? (_customs = new InputList<Inputs.RulesRuleTimeslotCustomArgs>());
            set => _customs = value;
        }
        ...
        public RulesRuleTimeslotArgs()
        {
        }
        public static new RulesRuleTimeslotArgs Empty => new RulesRuleTimeslotArgs();
    }
}
