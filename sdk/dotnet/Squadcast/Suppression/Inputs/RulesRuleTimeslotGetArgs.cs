...
namespace IrisDanded.Pulumi.Squadcast.Suppression.Inputs
{
    ...
    public sealed class RulesRuleTimeslotGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("customs")]
        private InputList<Inputs.RulesRuleTimeslotCustomGetArgs>? _customs;
        ...
        /// </summary>
        public InputList<Inputs.RulesRuleTimeslotCustomGetArgs> Customs
        {
            get => _customs ?? (_customs = new InputList<Inputs.RulesRuleTimeslotCustomGetArgs>());
            set => _customs = value;
        }
        ...
        public RulesRuleTimeslotGetArgs()
        {
        }
        public static new RulesRuleTimeslotGetArgs Empty => new RulesRuleTimeslotGetArgs();
    }
}
