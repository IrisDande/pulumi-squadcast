...
namespace IrisDanded.Pulumi.Squadcast.Suppression.Rule.Inputs
{
    ...
    public sealed class V2TimeslotArgs : global::Pulumi.ResourceArgs
    {
        [Input("customs")]
        private InputList<Inputs.V2TimeslotCustomArgs>? _customs;
        ...
        /// </summary>
        public InputList<Inputs.V2TimeslotCustomArgs> Customs
        {
            get => _customs ?? (_customs = new InputList<Inputs.V2TimeslotCustomArgs>());
            set => _customs = value;
        }
        ...
        public V2TimeslotArgs()
        {
        }
        public static new V2TimeslotArgs Empty => new V2TimeslotArgs();
    }
}
