...
namespace IrisDanded.Pulumi.Squadcast.Suppression.Rule.Inputs
{
    ...
    public sealed class V2TimeslotGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("customs")]
        private InputList<Inputs.V2TimeslotCustomGetArgs>? _customs;
        ...
        /// </summary>
        public InputList<Inputs.V2TimeslotCustomGetArgs> Customs
        {
            get => _customs ?? (_customs = new InputList<Inputs.V2TimeslotCustomGetArgs>());
            set => _customs = value;
        }
        ...
        public V2TimeslotGetArgs()
        {
        }
        public static new V2TimeslotGetArgs Empty => new V2TimeslotGetArgs();
    }
}
