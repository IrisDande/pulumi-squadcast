...
namespace IrisDanded.Pulumi.Squadcast.SuppressionRule.Inputs
{
    ...
    public sealed class RuleV2TimeslotArgs : global::Pulumi.ResourceArgs
    {
        [Input("customs")]
        private InputList<Inputs.RuleV2TimeslotCustomArgs>? _customs;
        ...
        /// </summary>
        public InputList<Inputs.RuleV2TimeslotCustomArgs> Customs
        {
            get => _customs ?? (_customs = new InputList<Inputs.RuleV2TimeslotCustomArgs>());
            set => _customs = value;
        }
        ...
        public RuleV2TimeslotArgs()
        {
        }
        public static new RuleV2TimeslotArgs Empty => new RuleV2TimeslotArgs();
    }
}
