...
namespace IrisDanded.Pulumi.Squadcast.SuppressionRule.Inputs
{
    ...
    public sealed class RuleV2TimeslotGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("customs")]
        private InputList<Inputs.RuleV2TimeslotCustomGetArgs>? _customs;
        ...
        /// </summary>
        public InputList<Inputs.RuleV2TimeslotCustomGetArgs> Customs
        {
            get => _customs ?? (_customs = new InputList<Inputs.RuleV2TimeslotCustomGetArgs>());
            set => _customs = value;
        }
        ...
        public RuleV2TimeslotGetArgs()
        {
        }
        public static new RuleV2TimeslotGetArgs Empty => new RuleV2TimeslotGetArgs();
    }
}
