...
namespace IrisDanded.Pulumi.Squadcast.SuppressionRule.Outputs
{
    ...
    [OutputType]
    public sealed class RuleV2Timeslot
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.RuleV2TimeslotCustom> Customs;
        /// <summary>
        ...
        [OutputConstructor]
        private RuleV2Timeslot(
            ImmutableArray<Outputs.RuleV2TimeslotCustom> customs,
