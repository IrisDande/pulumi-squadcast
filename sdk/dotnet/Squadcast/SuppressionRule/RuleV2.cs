...
namespace IrisDanded.Pulumi.Squadcast.SuppressionRule
{
    /// <summary>
    ...
    ///     });
    /// 
    ///     var exampleBasicSuppressionRules = new Squadcast.SuppressionRule.RuleV2("exampleBasicSuppressionRules", new()
    ///     {
    ...
    ///         {
    ///             new Squadcast.SuppressionRule.Inputs.RuleV2BasicExpressionArgs
    ///             {
    ///                 Lhs = "abc",
    ///                 Op = "is",
    ///                 Rhs = "xyz",
    ...
    ///     });
    /// 
    ///     var exampleSuppressionRules = new Squadcast.SuppressionRule.RuleV2("exampleSuppressionRules", new()
    ///     {
    ///         ServiceId = exampleService.Apply(getServiceResult =&gt; getServiceResult.Id),
    ///         IsBasic = false,
    ...
    ///     });
    /// 
    ///     var exampleTimeBasedSuppressionRules = new Squadcast.SuppressionRule.RuleV2("exampleTimeBasedSuppressionRules", new()
    ///     {
    ///         ServiceId = exampleService.Apply(getServiceResult =&gt; getServiceResult.Id),
    ///         IsBasic = false,
    ///         Description = "not basic",
    ...
    ///         Timeslots = new[]
    ///         {
    ///             new Squadcast.SuppressionRule.Inputs.RuleV2TimeslotArgs
    ///             {
    ...
    ///     });
    /// 
    ///     var exampleTimeBasedSuppressionRulesCustomRepetition = new Squadcast.SuppressionRule.RuleV2("exampleTimeBasedSuppressionRulesCustomRepetition", new()
    ///     {
    ///         ServiceId = exampleService.Apply(getServiceResult =&gt; getServiceResult.Id),
    ///         IsBasic = false,
    ///         Description = "not basic",
    ...
    ///                 Customs = new[]
    ///                 {
    ///                     new Squadcast.SuppressionRule.Inputs.RuleV2TimeslotCustomArgs
    ///                     {
    ///                         Repeats = "day",
    ///                         RepeatsCount = 2,
    ///                     },
    ...
    /// ```
    /// </summary>
    [SquadcastResourceType("squadcast:SuppressionRule/ruleV2:RuleV2")]
    public partial class RuleV2 : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("timeslots")]
        public Output<ImmutableArray<Outputs.RuleV2Timeslot>> Timeslots { get; private set; } = null!;
        ...
        public RuleV2(string name, RuleV2Args args, CustomResourceOptions? options = null)
            : base("squadcast:SuppressionRule/ruleV2:RuleV2", name, args ?? new RuleV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private RuleV2(string name, Input<string> id, RuleV2State? state = null, CustomResourceOptions? options = null)
            : base("squadcast:SuppressionRule/ruleV2:RuleV2", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RuleV2Args : global::Pulumi.ResourceArgs
    {
        ...
        [Input("timeslots")]
        private InputList<Inputs.RuleV2TimeslotArgs>? _timeslots;

        /// <summary>
        /// The timeslots for which this rule should be applied.
        /// </summary>
        public InputList<Inputs.RuleV2TimeslotArgs> Timeslots
        {
            get => _timeslots ?? (_timeslots = new InputList<Inputs.RuleV2TimeslotArgs>());
    ...
    public sealed class RuleV2State : global::Pulumi.ResourceArgs
    {
        ...
        [Input("timeslots")]
        private InputList<Inputs.RuleV2TimeslotGetArgs>? _timeslots;

        /// <summary>
        /// The timeslots for which this rule should be applied.
        /// </summary>
        public InputList<Inputs.RuleV2TimeslotGetArgs> Timeslots
        {
            get => _timeslots ?? (_timeslots = new InputList<Inputs.RuleV2TimeslotGetArgs>());
            set => _timeslots = value;
        }
