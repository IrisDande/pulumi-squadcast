...
namespace IrisDanded.Pulumi.Squadcast
{
    ...
    /// ```
    /// </summary>
    [SquadcastResourceType("squadcast:index/suppressionRuleV2:SuppressionRuleV2")]
    public partial class SuppressionRuleV2 : global::Pulumi.CustomResource
    {
        /// <summary>
        /// The basic expression which needs to be evaluated to be true for this rule to apply.
        /// </summary>
        [Output("basicExpressions")]
        public Output<ImmutableArray<Outputs.SuppressionRuleV2BasicExpression>> BasicExpressions { get; private set; } = null!;
        ...
        /// </summary>
        [Output("timeslots")]
        public Output<ImmutableArray<Outputs.SuppressionRuleV2Timeslot>> Timeslots { get; private set; } = null!;
        ...
        public SuppressionRuleV2(string name, SuppressionRuleV2Args args, CustomResourceOptions? options = null)
            : base("squadcast:index/suppressionRuleV2:SuppressionRuleV2", name, args ?? new SuppressionRuleV2Args(), MakeResourceOptions(options, ""))
        {
        }

        private SuppressionRuleV2(string name, Input<string> id, SuppressionRuleV2State? state = null, CustomResourceOptions? options = null)
            : base("squadcast:index/suppressionRuleV2:SuppressionRuleV2", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SuppressionRuleV2 Get(string name, Input<string> id, SuppressionRuleV2State? state = null, CustomResourceOptions? options = null)
        {
            return new SuppressionRuleV2(name, id, state, options);
        }
    }

    public sealed class SuppressionRuleV2Args : global::Pulumi.ResourceArgs
    {
        [Input("basicExpressions")]
        private InputList<Inputs.SuppressionRuleV2BasicExpressionArgs>? _basicExpressions;

        /// <summary>
        /// The basic expression which needs to be evaluated to be true for this rule to apply.
        /// </summary>
        public InputList<Inputs.SuppressionRuleV2BasicExpressionArgs> BasicExpressions
        {
            get => _basicExpressions ?? (_basicExpressions = new InputList<Inputs.SuppressionRuleV2BasicExpressionArgs>());
        ...
        [Input("timeslots")]
        private InputList<Inputs.SuppressionRuleV2TimeslotArgs>? _timeslots;

        /// <summary>
        /// The timeslots for which this rule should be applied.
        /// </summary>
        public InputList<Inputs.SuppressionRuleV2TimeslotArgs> Timeslots
        {
            get => _timeslots ?? (_timeslots = new InputList<Inputs.SuppressionRuleV2TimeslotArgs>());
            set => _timeslots = value;
        }

        public SuppressionRuleV2Args()
        {
        }
        public static new SuppressionRuleV2Args Empty => new SuppressionRuleV2Args();
    }

    public sealed class SuppressionRuleV2State : global::Pulumi.ResourceArgs
    {
        [Input("basicExpressions")]
        private InputList<Inputs.SuppressionRuleV2BasicExpressionGetArgs>? _basicExpressions;

        /// <summary>
        /// The basic expression which needs to be evaluated to be true for this rule to apply.
        /// </summary>
        public InputList<Inputs.SuppressionRuleV2BasicExpressionGetArgs> BasicExpressions
        {
            get => _basicExpressions ?? (_basicExpressions = new InputList<Inputs.SuppressionRuleV2BasicExpressionGetArgs>());
            set => _basicExpressions = value;
        }
        ...
        [Input("timeslots")]
        private InputList<Inputs.SuppressionRuleV2TimeslotGetArgs>? _timeslots;

        /// <summary>
        /// The timeslots for which this rule should be applied.
        /// </summary>
        public InputList<Inputs.SuppressionRuleV2TimeslotGetArgs> Timeslots
        {
            get => _timeslots ?? (_timeslots = new InputList<Inputs.SuppressionRuleV2TimeslotGetArgs>());
            set => _timeslots = value;
        }

        public SuppressionRuleV2State()
        {
        }
        public static new SuppressionRuleV2State Empty => new SuppressionRuleV2State();
    }
}
