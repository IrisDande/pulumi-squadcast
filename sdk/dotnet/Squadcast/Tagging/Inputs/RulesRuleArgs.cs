...
namespace IrisDanded.Pulumi.Squadcast.Tagging.Inputs
{
    ...
    public sealed class RulesRuleArgs : global::Pulumi.ResourceArgs
    {
        [Input("basicExpressions")]
        private InputList<Inputs.RulesRuleBasicExpressionArgs>? _basicExpressions;

        /// <summary>
        /// The basic expression which needs to be evaluated to be true for this rule to apply.
        /// </summary>
        public InputList<Inputs.RulesRuleBasicExpressionArgs> BasicExpressions
        {
            get => _basicExpressions ?? (_basicExpressions = new InputList<Inputs.RulesRuleBasicExpressionArgs>());
        ...
        [Input("tags")]
        private InputList<Inputs.RulesRuleTagArgs>? _tags;
        ...
        /// </summary>
        public InputList<Inputs.RulesRuleTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.RulesRuleTagArgs>());
            set => _tags = value;
        }

        public RulesRuleArgs()
        {
        }
        public static new RulesRuleArgs Empty => new RulesRuleArgs();
    }
}
