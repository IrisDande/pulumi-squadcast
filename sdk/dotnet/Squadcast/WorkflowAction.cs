...
namespace IrisDanded.Pulumi.Squadcast
{
    ...
    /// ## Example Usage
    /// </summary>
    [SquadcastResourceType("squadcast:index/workflowAction:WorkflowAction")]
    public partial class WorkflowAction : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("channels")]
        public Output<ImmutableArray<Outputs.WorkflowActionChannel>> Channels { get; private set; } = null!;

        /// <summary>
        /// The components and their impact to be set for the issue. (Only for Add Status Page Issue action)
        /// </summary>
        [Output("componentAndImpacts")]
        public Output<ImmutableArray<Outputs.WorkflowActionComponentAndImpact>> ComponentAndImpacts { get; private set; } = null!;
        ...
        /// </summary>
        [Output("headers")]
        public Output<ImmutableArray<Outputs.WorkflowActionHeader>> Headers { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.WorkflowActionStatusAndMessage>> StatusAndMessages { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a WorkflowAction resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public WorkflowAction(string name, WorkflowActionArgs args, CustomResourceOptions? options = null)
            : base("squadcast:index/workflowAction:WorkflowAction", name, args ?? new WorkflowActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkflowAction(string name, Input<string> id, WorkflowActionState? state = null, CustomResourceOptions? options = null)
            : base("squadcast:index/workflowAction:WorkflowAction", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WorkflowAction Get(string name, Input<string> id, WorkflowActionState? state = null, CustomResourceOptions? options = null)
        {
            return new WorkflowAction(name, id, state, options);
        }
    }

    public sealed class WorkflowActionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The account to be used for creating the ticket. (Only for Jira Create Ticket action)
        /// </summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WorkflowActionChannelArgs>? _channels;

        /// <summary>
        /// The communication channels to be added to the incident
        /// </summary>
        public InputList<Inputs.WorkflowActionChannelArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WorkflowActionChannelArgs>());
            set => _channels = value;
        }

        [Input("componentAndImpacts")]
        private InputList<Inputs.WorkflowActionComponentAndImpactArgs>? _componentAndImpacts;

        /// <summary>
        /// The components and their impact to be set for the issue. (Only for Add Status Page Issue action)
        /// </summary>
        public InputList<Inputs.WorkflowActionComponentAndImpactArgs> ComponentAndImpacts
        {
            get => _componentAndImpacts ?? (_componentAndImpacts = new InputList<Inputs.WorkflowActionComponentAndImpactArgs>());
        ...
        [Input("headers")]
        private InputList<Inputs.WorkflowActionHeaderArgs>? _headers;

        /// <summary>
        /// The headers to be sent with the request
        /// </summary>
        public InputList<Inputs.WorkflowActionHeaderArgs> Headers
        {
            get => _headers ?? (_headers = new InputList<Inputs.WorkflowActionHeaderArgs>());
            set => _headers = value;
        }
        ...
        private InputList<Inputs.WorkflowActionStatusAndMessageArgs>? _statusAndMessages;

        /// <summary>
        /// The status and message to be set for the issue. (Only for Add Status Page Issue action)
        /// </summary>
        public InputList<Inputs.WorkflowActionStatusAndMessageArgs> StatusAndMessages
        {
            get => _statusAndMessages ?? (_statusAndMessages = new InputList<Inputs.WorkflowActionStatusAndMessageArgs>());
        ...
        public WorkflowActionArgs()
        {
        }
        public static new WorkflowActionArgs Empty => new WorkflowActionArgs();
    }

    public sealed class WorkflowActionState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The account to be used for creating the ticket. (Only for Jira Create Ticket action)
        /// </summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WorkflowActionChannelGetArgs>? _channels;

        /// <summary>
        /// The communication channels to be added to the incident
        /// </summary>
        public InputList<Inputs.WorkflowActionChannelGetArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WorkflowActionChannelGetArgs>());
            set => _channels = value;
        }

        [Input("componentAndImpacts")]
        private InputList<Inputs.WorkflowActionComponentAndImpactGetArgs>? _componentAndImpacts;

        /// <summary>
        /// The components and their impact to be set for the issue. (Only for Add Status Page Issue action)
        /// </summary>
        public InputList<Inputs.WorkflowActionComponentAndImpactGetArgs> ComponentAndImpacts
        {
            get => _componentAndImpacts ?? (_componentAndImpacts = new InputList<Inputs.WorkflowActionComponentAndImpactGetArgs>());
            set => _componentAndImpacts = value;
        }
        ...
        [Input("headers")]
        private InputList<Inputs.WorkflowActionHeaderGetArgs>? _headers;

        /// <summary>
        /// The headers to be sent with the request
        /// </summary>
        public InputList<Inputs.WorkflowActionHeaderGetArgs> Headers
        {
            get => _headers ?? (_headers = new InputList<Inputs.WorkflowActionHeaderGetArgs>());
            set => _headers = value;
        }
        ...
        [Input("statusAndMessages")]
        private InputList<Inputs.WorkflowActionStatusAndMessageGetArgs>? _statusAndMessages;

        /// <summary>
        /// The status and message to be set for the issue. (Only for Add Status Page Issue action)
        /// </summary>
        public InputList<Inputs.WorkflowActionStatusAndMessageGetArgs> StatusAndMessages
        {
            get => _statusAndMessages ?? (_statusAndMessages = new InputList<Inputs.WorkflowActionStatusAndMessageGetArgs>());
            set => _statusAndMessages = value;
        }
        ...
        public WorkflowActionState()
        {
        }
        public static new WorkflowActionState Empty => new WorkflowActionState();
    }
}
