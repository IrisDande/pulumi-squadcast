...
//				return err
//			}
//			_, err = deduplication.NewV2(ctx, "exampleDeduplicationRule", &deduplication.V2Args{
...
//				return err
//			}
//			_, err = deduplication.NewV2(ctx, "exampleBasicDeduplicationRule", &deduplication.V2Args{
//				ServiceId:               pulumi.String(exampleService.Id),
...
func NewV2(ctx *pulumi.Context,
	...
	var resource V2
	err := ctx.RegisterResource("squadcast:deduplication/rule/v2:V2", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetV2(ctx *pulumi.Context,
	...
	var resource V2
	err := ctx.ReadResource("squadcast:deduplication/rule/v2:V2", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Denotes if dependent services should also be deduplicated
func (o V2Output) DependencyDeduplication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *V2) pulumi.BoolPtrOutput { return v.DependencyDeduplication }).(pulumi.BoolPtrOutput)
}
...
// time unit (mins or hours)
func (o V2Output) TimeUnit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *V2) pulumi.StringPtrOutput { return v.TimeUnit }).(pulumi.StringPtrOutput)
}

// integer for time_unit
func (o V2Output) TimeWindow() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *V2) pulumi.IntPtrOutput { return v.TimeWindow }).(pulumi.IntPtrOutput)
}
