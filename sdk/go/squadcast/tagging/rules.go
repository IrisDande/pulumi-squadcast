...
func NewRules(ctx *pulumi.Context,
	...
	var resource Rules
	err := ctx.RegisterResource("squadcast:tagging/rules:Rules", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRules(ctx *pulumi.Context,
	...
	var resource Rules
	err := ctx.ReadResource("squadcast:tagging/rules:Rules", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
