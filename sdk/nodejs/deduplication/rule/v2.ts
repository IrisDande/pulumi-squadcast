 ...
 * }));
 * const exampleDeduplicationRule = new squadcast.deduplication.rule.V2("exampleDeduplicationRule", {
 *     serviceId: exampleService.then(exampleService => exampleService.id),
 *     isBasic: false,
 *     description: "not basic",
 *     expression: "payload[\"event_id\"] == 40",
 * });
 * const exampleBasicDeduplicationRule = new squadcast.deduplication.rule.V2("exampleBasicDeduplicationRule", {
 *     serviceId: exampleService.then(exampleService => exampleService.id),
 *     isBasic: true,
 *     description: "basic",
...
export class V2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'squadcast:deduplication/rule/v2:V2';
     ...
     */
    public readonly basicExpressions!: pulumi.Output<outputs.deduplication.rule.V2BasicExpression[] | undefined>;
    /**
...
export interface V2State {
     ...
     * The basic expression which needs to be evaluated to be true for this rule to apply.
     */
    basicExpressions?: pulumi.Input<pulumi.Input<inputs.deduplication.rule.V2BasicExpression>[]>;
    /**
     * Denotes if dependent services should also be deduplicated
     */
