...
export class Rules extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'squadcast:deduplication/rules:Rules';
    ...
    public readonly rules!: pulumi.Output<outputs.deduplication.RulesRule[]>;
    /**
     * Service id.
     */
...
export interface RulesState {
    rules?: pulumi.Input<pulumi.Input<inputs.deduplication.RulesRule>[]>;
    /**
     * Service id.
     */
