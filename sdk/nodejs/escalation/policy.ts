 ...
 * }));
 * const exampleScheduleV2 = exampleTeam.then(exampleTeam => squadcast.schedule.getV2({
 *     name: "example schedule name",
 *     teamId: exampleTeam.id,
 * }));
 * const exampleEscalaionPolicy = new squadcast.escalation.Policy("exampleEscalaionPolicy", {
...
export class Policy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'squadcast:escalation/policy:Policy';
     ...
     */
    public readonly entityOwner!: pulumi.Output<outputs.escalation.PolicyEntityOwner>;
    /**
     ...
     */
    public readonly repeat!: pulumi.Output<outputs.escalation.PolicyRepeat | undefined>;
    /**
     * Rules will have the details of who to notify and when to notify and how to notify them.
     */
    public readonly rules!: pulumi.Output<outputs.escalation.PolicyRule[]>;
    /**
     * Team id.
     */
...
export interface PolicyState {
     ...
     * Escalation policy owner.
     */
    entityOwner?: pulumi.Input<inputs.escalation.PolicyEntityOwner>;
    /**
     * Name of the Escalation Policy.
     */
     ...
     * You can choose to repeate the entire policy, if no one acknowledges the incident even after the Escalation Policy has been executed fully once
     */
    repeat?: pulumi.Input<inputs.escalation.PolicyRepeat>;
    /**
     * Rules will have the details of who to notify and when to notify and how to notify them.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.escalation.PolicyRule>[]>;
    /**
     * Team id.
     */
