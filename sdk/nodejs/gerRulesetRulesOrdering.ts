 ...
 * ```
 */
export class GerRulesetRulesOrdering extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GerRulesetRulesOrderingState, opts?: pulumi.CustomResourceOptions): GerRulesetRulesOrdering {
        return new GerRulesetRulesOrdering(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'squadcast:index/gerRulesetRulesOrdering:GerRulesetRulesOrdering';

    /**
     * Returns true if the given object is an instance of GerRulesetRulesOrdering.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GerRulesetRulesOrdering {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GerRulesetRulesOrdering.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: GerRulesetRulesOrderingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: GerRulesetRulesOrderingArgs | GerRulesetRulesOrderingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GerRulesetRulesOrderingState | undefined;
            ...
            const args = argsOrState as GerRulesetRulesOrderingArgs | undefined;
        ...
        super(GerRulesetRulesOrdering.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface GerRulesetRulesOrderingState {
    /**
     * An alert source refers to the origin of an event (alert), such as a monitoring tool. These alert sources are associated with specific rules in GER, determining where events from each source should be routed. Find all alert sources supported on Squadcast [here](https://www.squadcast.com/integrations).
     */
 ...
 */
export interface GerRulesetRulesOrderingArgs {
    /**
     * An alert source refers to the origin of an event (alert), such as a monitoring tool. These alert sources are associated with specific rules in GER, determining where events from each source should be routed. Find all alert sources supported on Squadcast [here](https://www.squadcast.com/integrations).
     */
    alertSource: pulumi.Input<string>;
