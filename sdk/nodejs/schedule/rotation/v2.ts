 ...
 * });
 * const getSchedule = exampleTeam.then(exampleTeam => squadcast.schedule.getV2({
 *     name: "Test Schedule",
 *     teamId: exampleTeam.id,
 * }));
 * // Create a rotation with weekly period
 * const rotationsWithWeeklyPeriod = new squadcast.schedule.rotation.V2("rotationsWithWeeklyPeriod", {
 ...
 * const rotationsWithCustomPeriod = new squadcast.schedule.rotation.V2("rotationsWithCustomPeriod", {
 *     scheduleId: getSchedule.then(getSchedule => getSchedule.id),
...
export class V2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'squadcast:schedule/rotation/v2:V2';
     ...
     */
    public readonly participantGroups!: pulumi.Output<outputs.schedule.rotation.V2ParticipantGroup[] | undefined>;
    /**
     ...
     */
    public readonly shiftTimeslots!: pulumi.Output<outputs.schedule.rotation.V2ShiftTimeslot[]>;
    /**
...
export interface V2State {
     ...
     * Ordered list of participant groups for the rotation. For each rotation the participant*groups are cycled through in order.
     */
    participantGroups?: pulumi.Input<pulumi.Input<inputs.schedule.rotation.V2ParticipantGroup>[]>;
    /**
     * Rotation period (none, daily, weekly, monthly, custom). Defines how often the rotation repeats.
     */
     ...
     * Timeslots where the rotation is active.
     */
    shiftTimeslots?: pulumi.Input<pulumi.Input<inputs.schedule.rotation.V2ShiftTimeslot>[]>;
    /**
     * Defines the start date of the rotation.
     */
