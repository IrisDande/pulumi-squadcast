...
export class StatusPage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'squadcast:index/statusPage:StatusPage';
     ...
     * Status page owner.
     */
    public readonly owner!: pulumi.Output<outputs.StatusPageOwner>;
    /**
     * Team id.
     */
     ...
     */
    public readonly themeColor!: pulumi.Output<outputs.StatusPageThemeColor>;
    /**
...
export interface StatusPageState {
     ...
     * Status page owner.
     */
    owner?: pulumi.Input<inputs.StatusPageOwner>;
    /**
     * Team id.
     */
     ...
     * Theme color for the status page.
     */
    themeColor?: pulumi.Input<inputs.StatusPageThemeColor>;
    /**
     * Timezone for the status page.
     */
