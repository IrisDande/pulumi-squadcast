 ...
 * }));
 * const exampleBasicSuppressionRules = new squadcast.suppression.rule.V2("exampleBasicSuppressionRules", {
 ...
 *     }],
 * });
 * const exampleSuppressionRules = new squadcast.suppression.rule.V2("exampleSuppressionRules", {
 *     serviceId: exampleService.then(exampleService => exampleService.id),
 *     isBasic: false,
 *     description: "not basic",
 *     expression: "payload[\"event_id\"] == 40",
 * });
 * const exampleTimeBasedSuppressionRules = new squadcast.suppression.rule.V2("exampleTimeBasedSuppressionRules", {
 *     serviceId: exampleService.then(exampleService => exampleService.id),
 *     isBasic: false,
 *     description: "not basic",
 *     expression: "payload[\"event_id\"] == 40",
 ...
 *     }],
 * });
 * const exampleTimeBasedSuppressionRulesCustomRepetition = new squadcast.suppression.rule.V2("exampleTimeBasedSuppressionRulesCustomRepetition", {
 *     serviceId: exampleService.then(exampleService => exampleService.id),
 *     isBasic: false,
 *     description: "not basic",
 *     expression: "payload[\"event_id\"] == 40",
...
export class V2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'squadcast:suppression/rule/v2:V2';
     ...
     */
    public readonly basicExpressions!: pulumi.Output<outputs.suppression.rule.V2BasicExpression[] | undefined>;
    /**
     * description.
     */
     ...
     */
    public readonly timeslots!: pulumi.Output<outputs.suppression.rule.V2Timeslot[] | undefined>;
...
export interface V2State {
     ...
     * The basic expression which needs to be evaluated to be true for this rule to apply.
     */
    basicExpressions?: pulumi.Input<pulumi.Input<inputs.suppression.rule.V2BasicExpression>[]>;
    /**
     * description.
     */
     ...
     * The timeslots for which this rule should be applied.
     */
    timeslots?: pulumi.Input<pulumi.Input<inputs.suppression.rule.V2Timeslot>[]>;
}
