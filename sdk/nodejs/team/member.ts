 ...
 * });
 * const exampleTeamRole = exampleTeam.then(exampleTeam => squadcast.team.getRole({
 *     name: "example role name",
 *     teamId: exampleTeam.id,
 * }));
 * const exampleTeamMember = new squadcast.team.Member("exampleTeamMember", {
...
export class Member extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'squadcast:team/member:Member';
