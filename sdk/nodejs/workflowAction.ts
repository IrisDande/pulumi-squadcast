 ...
 * ## Example Usage
 */
export class WorkflowAction extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkflowActionState, opts?: pulumi.CustomResourceOptions): WorkflowAction {
        return new WorkflowAction(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'squadcast:index/workflowAction:WorkflowAction';

    /**
     * Returns true if the given object is an instance of WorkflowAction.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WorkflowAction {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WorkflowAction.__pulumiType;
    }
     ...
     */
    public readonly channels!: pulumi.Output<outputs.WorkflowActionChannel[] | undefined>;
    /**
     * The components and their impact to be set for the issue. (Only for Add Status Page Issue action)
     */
    public readonly componentAndImpacts!: pulumi.Output<outputs.WorkflowActionComponentAndImpact[] | undefined>;
    /**
     ...
     */
    public readonly headers!: pulumi.Output<outputs.WorkflowActionHeader[] | undefined>;
    /**
     ...
     */
    public readonly statusAndMessages!: pulumi.Output<outputs.WorkflowActionStatusAndMessage[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: WorkflowActionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WorkflowActionArgs | WorkflowActionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WorkflowActionState | undefined;
            ...
            const args = argsOrState as WorkflowActionArgs | undefined;
        ...
        super(WorkflowAction.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface WorkflowActionState {
     ...
     * The communication channels to be added to the incident
     */
    channels?: pulumi.Input<pulumi.Input<inputs.WorkflowActionChannel>[]>;
    /**
     * The components and their impact to be set for the issue. (Only for Add Status Page Issue action)
     */
    componentAndImpacts?: pulumi.Input<pulumi.Input<inputs.WorkflowActionComponentAndImpact>[]>;
    /**
     * The description of the ticket. (Only for Jira Create Ticket action)
     */
     ...
     * The headers to be sent with the request
     */
    headers?: pulumi.Input<pulumi.Input<inputs.WorkflowActionHeader>[]>;
    /**
     * The title of the issue to be added. (Only for Add Status Page Issue action)
     */
     ...
     * The status and message to be set for the issue. (Only for Add Status Page Issue action)
     */
    statusAndMessages?: pulumi.Input<pulumi.Input<inputs.WorkflowActionStatusAndMessage>[]>;
    /**
     * The ID of the status page to which the issue is to be added. (Only for Add Status Page Issue action)
     */
