...
class V2Timeslot(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in V2Timeslot. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        V2Timeslot.__key_warning(key)
    ...
    def __init__(__self__, *,
                 ...
                 start_time: str,
                 time_zone: str,
                 customs: Optional[Sequence['outputs.V2TimeslotCustom']] = None,
        ...
        :param Sequence['V2TimeslotCustomArgs'] customs: Use this field to specify the custom time slots for which this rule should be applied. This field is only applicable when the repetition field is set to custom.
    ...
    @property
    @pulumi.getter
    def customs(self) -> Optional[Sequence['outputs.V2TimeslotCustom']]:
        """
...
class V2TimeslotCustom(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in V2TimeslotCustom. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        V2TimeslotCustom.__key_warning(key)
        return super().__getitem__(key)
