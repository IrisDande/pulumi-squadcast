...
__all__ = ['DeduplicationRuleV2Args', 'DeduplicationRuleV2']

@pulumi.input_type
class DeduplicationRuleV2Args:
    def __init__(__self__, *,
                 is_basic: pulumi.Input[bool],
                 service_id: pulumi.Input[str],
                 basic_expressions: Optional[pulumi.Input[Sequence[pulumi.Input['DeduplicationRuleV2BasicExpressionArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DeduplicationRuleV2BasicExpressionArgs']]] basic_expressions: The basic expression which needs to be evaluated to be true for this rule to apply.
    ...
    def basic_expressions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DeduplicationRuleV2BasicExpressionArgs']]]]:
        """
    ...
    def basic_expressions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DeduplicationRuleV2BasicExpressionArgs']]]]):
...
@pulumi.input_type
class _DeduplicationRuleV2State:
    def __init__(__self__, *,
                 basic_expressions: Optional[pulumi.Input[Sequence[pulumi.Input['DeduplicationRuleV2BasicExpressionArgs']]]] = None,
                 dependency_deduplication: Optional[pulumi.Input[bool]] = None,
                 description: Optional[pulumi.Input[str]] = None,
...
class DeduplicationRuleV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 basic_expressions: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DeduplicationRuleV2BasicExpressionArgs']]]]] = None,
                 dependency_deduplication: Optional[pulumi.Input[bool]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 expression: Optional[pulumi.Input[str]] = None,
                 is_basic: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DeduplicationRuleV2BasicExpressionArgs']]]] basic_expressions: The basic expression which needs to be evaluated to be true for this rule to apply.
        :param pulumi.Input[bool] dependency_deduplication: Denotes if dependent services should also be deduplicated
        :param pulumi.Input[str] description: description.
        :param pulumi.Input[str] expression: The expression which needs to be evaluated to be true for this rule to apply.
        :param pulumi.Input[bool] is_basic: is_basic will be true when users use the drop down selectors which will have lhs, op & rhs value, whereas it will be false when they use the advanced mode and it would have the expression for it's value
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DeduplicationRuleV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DeduplicationRuleV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DeduplicationRuleV2Args.__new__(DeduplicationRuleV2Args)
        ...
        super(DeduplicationRuleV2, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            service_id: Optional[pulumi.Input[str]] = None,
            time_unit: Optional[pulumi.Input[str]] = None,
            time_window: Optional[pulumi.Input[int]] = None) -> 'DeduplicationRuleV2':
        """
        ...
        __props__ = _DeduplicationRuleV2State.__new__(_DeduplicationRuleV2State)
        ...
        __props__.__dict__["time_unit"] = time_unit
        __props__.__dict__["time_window"] = time_window
        return DeduplicationRuleV2(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="basicExpressions")
    def basic_expressions(self) -> pulumi.Output[Optional[Sequence['outputs.DeduplicationRuleV2BasicExpression']]]:
        """
        The basic expression which needs to be evaluated to be true for this rule to apply.
        """
        return pulumi.get(self, "basic_expressions")
