...
class PolicyArgs:
    def __init__(__self__, *,
                 entity_owner: pulumi.Input['PolicyEntityOwnerArgs'],
                 rules: pulumi.Input[Sequence[pulumi.Input['PolicyRuleArgs']]],
                 team_id: pulumi.Input[str],
                 description: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 repeat: Optional[pulumi.Input['PolicyRepeatArgs']] = None):
        """
        The set of arguments for constructing a Policy resource.
        :param pulumi.Input['PolicyEntityOwnerArgs'] entity_owner: Escalation policy owner.
        :param pulumi.Input[Sequence[pulumi.Input['PolicyRuleArgs']]] rules: Rules will have the details of who to notify and when to notify and how to notify them.
        ...
        :param pulumi.Input['PolicyRepeatArgs'] repeat: You can choose to repeate the entire policy, if no one acknowledges the incident even after the Escalation Policy has been executed fully once
        """
    ...
    def entity_owner(self) -> pulumi.Input['PolicyEntityOwnerArgs']:
        """
    ...
    @entity_owner.setter
    def entity_owner(self, value: pulumi.Input['PolicyEntityOwnerArgs']):
    ...
    @property
    @pulumi.getter
    def repeat(self) -> Optional[pulumi.Input['PolicyRepeatArgs']]:
        """
    ...
    @repeat.setter
    def repeat(self, value: Optional[pulumi.Input['PolicyRepeatArgs']]):
...
class _PolicyState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[str]] = None,
                 entity_owner: Optional[pulumi.Input['PolicyEntityOwnerArgs']] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 repeat: Optional[pulumi.Input['PolicyRepeatArgs']] = None,
    ...
    @property
    @pulumi.getter(name="entityOwner")
    def entity_owner(self) -> Optional[pulumi.Input['PolicyEntityOwnerArgs']]:
        """
        Escalation policy owner.
        """
        return pulumi.get(self, "entity_owner")
    ...
    @entity_owner.setter
    def entity_owner(self, value: Optional[pulumi.Input['PolicyEntityOwnerArgs']]):
        pulumi.set(self, "entity_owner", value)
...
class Policy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 entity_owner: Optional[pulumi.Input[pulumi.InputType['PolicyEntityOwnerArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 repeat: Optional[pulumi.Input[pulumi.InputType['PolicyRepeatArgs']]] = None,
        ...
        example_escalaion_policy = squadcast.escalation.Policy("exampleEscalaionPolicy",
            ...
            team_id=example_team.id,
            rules=[
                squadcast.escalation.PolicyRuleArgs(
                    delay_minutes=0,
                    targets=[
                        squadcast.escalation.PolicyRuleTargetArgs(
                            id=example_user.id,
                            type="user",
                        ),
                        squadcast.escalation.PolicyRuleTargetArgs(
                ...
                squadcast.escalation.PolicyRuleArgs(
                    ...
                    repeat=squadcast.escalation.PolicyRuleRepeatArgs(
                        times=1,
                        delay_minutes=5,
                    ),
                ),
                squadcast.escalation.PolicyRuleArgs(
                    ...
                    round_robin=squadcast.escalation.PolicyRuleRoundRobinArgs(
                        enabled=True,
                        rotation=squadcast.escalation.PolicyRuleRoundRobinRotationArgs(
                            enabled=True,
                            delay_minutes=1,
                        ),
                    ),
            ...
            repeat=squadcast.escalation.PolicyRepeatArgs(
                times=2,
                delay_minutes=10,
            ),
            entity_owner=squadcast.escalation.PolicyEntityOwnerArgs(
                id=example_user.id,
                type="user",
            ))
        ```
        ...
        :param pulumi.Input[str] description: Detailed description about the Escalation Policy.
        :param pulumi.Input[pulumi.InputType['PolicyEntityOwnerArgs']] entity_owner: Escalation policy owner.
        :param pulumi.Input[str] name: Name of the Escalation Policy.
        :param pulumi.Input[pulumi.InputType['PolicyRepeatArgs']] repeat: You can choose to repeate the entire policy, if no one acknowledges the incident even after the Escalation Policy has been executed fully once
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PolicyRuleArgs']]]] rules: Rules will have the details of who to notify and when to notify and how to notify them.
        :param pulumi.Input[str] team_id: Team id.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            repeat: Optional[pulumi.Input[pulumi.InputType['PolicyRepeatArgs']]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PolicyRuleArgs']]]]] = None,
            team_id: Optional[pulumi.Input[str]] = None) -> 'Policy':
        """
    ...
    @property
    @pulumi.getter(name="entityOwner")
    def entity_owner(self) -> pulumi.Output['outputs.PolicyEntityOwner']:
        """
        Escalation policy owner.
        """
        return pulumi.get(self, "entity_owner")
    ...
    @property
    @pulumi.getter
    def repeat(self) -> pulumi.Output[Optional['outputs.PolicyRepeat']]:
        """
        You can choose to repeate the entire policy, if no one acknowledges the incident even after the Escalation Policy has been executed fully once
        """
        return pulumi.get(self, "repeat")
