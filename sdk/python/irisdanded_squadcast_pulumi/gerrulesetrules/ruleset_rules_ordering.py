...
__all__ = ['RulesetRulesOrderingArgs', 'RulesetRulesOrdering']

@pulumi.input_type
class RulesetRulesOrderingArgs:
    def __init__(__self__, *,
                 alert_source: pulumi.Input[str],
                 ger_id: pulumi.Input[str],
                 orderings: pulumi.Input[Sequence[pulumi.Input[str]]]):
        """
        The set of arguments for constructing a RulesetRulesOrdering resource.
...
@pulumi.input_type
class _RulesetRulesOrderingState:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering RulesetRulesOrdering resources.
        :param pulumi.Input[str] alert_source: An alert source refers to the origin of an event (alert), such as a monitoring tool. These alert sources are associated with specific rules in GER, determining where events from each source should be routed. Find all alert sources supported on Squadcast [here](https://www.squadcast.com/integrations).
...
class RulesetRulesOrdering(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example_ger_ruleset_rule1 = squadcast.ger_ruleset.RulesetRule("exampleGerRulesetRule1",
            ger_id=example_ger.id,
        ...
        example_ger_ruleset_rule2 = squadcast.ger_ruleset.RulesetRule("exampleGerRulesetRule2",
            ger_id=example_ger.id,
            alert_source=example_ger_ruleset.alert_source,
        ...
        rule_ordering = squadcast.ger_ruleset_rules.RulesetRulesOrdering("ruleOrdering",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param RulesetRulesOrderingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RulesetRulesOrderingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RulesetRulesOrderingArgs.__new__(RulesetRulesOrderingArgs)
        ...
        super(RulesetRulesOrdering, __self__).__init__(
            'squadcast:GerRulesetRules/rulesetRulesOrdering:RulesetRulesOrdering',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            alert_source_version: Optional[pulumi.Input[str]] = None,
            ger_id: Optional[pulumi.Input[str]] = None,
            orderings: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'RulesetRulesOrdering':
        """
        ...
        __props__ = _RulesetRulesOrderingState.__new__(_RulesetRulesOrderingState)
        ...
        __props__.__dict__["ger_id"] = ger_id
        __props__.__dict__["orderings"] = orderings
        return RulesetRulesOrdering(resource_name, opts=opts, __props__=__props__)
