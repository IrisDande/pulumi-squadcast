...
class V2(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_squad = squadcast.get_squad(name="example squad name",
            team_id=example_team.id)
        example_routing_rules = squadcast.routing.rule.V2("exampleRoutingRules",
            service_id=example_service.id,
            is_basic=False,
            expression="payload[\\"event_id\\"] == 40",
            route_to_id=example_user.id,
            route_to_type="user")
        example_routing_rules_basic = squadcast.routing.rule.V2("exampleRoutingRulesBasic",
            service_id=example_service.id,
            is_basic=True,
            basic_expressions=[squadcast.routing.rule.V2BasicExpressionArgs(
                lhs="payload[\\"foo\\"]",
                rhs="bar",
            )],
    ...
    def get(resource_name: str,
            ...
            route_to_id: Optional[pulumi.Input[str]] = None,
            route_to_type: Optional[pulumi.Input[str]] = None,
            service_id: Optional[pulumi.Input[str]] = None) -> 'V2':
        """
