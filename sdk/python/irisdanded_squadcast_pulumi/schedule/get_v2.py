...
class GetV2Result:
    ...
    def entity_owners(self) -> Sequence['outputs.GetV2EntityOwnerResult']:
        """
        Schedule owner.
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetV2TagResult']:
        """
        Schedule tags.
        """
...
class AwaitableGetV2Result(GetV2Result):
...
def get_v2(name: Optional[str] = None,
           team_id: Optional[str] = None,
           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetV2Result:
    """
...
@_utilities.lift_output_func(get_v2)
def get_v2_output(name: Optional[pulumi.Input[str]] = None,
                  team_id: Optional[pulumi.Input[str]] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetV2Result]:
    """
    [Squadcast schedules v2](https://support.squadcast.com/schedules/schedules-new) are used to manage on-call scheduling & determine who will be notified when an incident is triggered. Use this data source to get information about a specific schedule that you can use for other Squadcast resources.
