...
__all__ = [
    'RotationV2ParticipantGroupArgs',
    'RotationV2ParticipantGroupParticipantArgs',
    'RotationV2ShiftTimeslotArgs',
]

@pulumi.input_type
class RotationV2ParticipantGroupArgs:
    def __init__(__self__, *,
                 participants: Optional[pulumi.Input[Sequence[pulumi.Input['RotationV2ParticipantGroupParticipantArgs']]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['RotationV2ParticipantGroupParticipantArgs']]] participants: Group participants.
        """
    ...
    @property
    @pulumi.getter
    def participants(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RotationV2ParticipantGroupParticipantArgs']]]]:
        """
        Group participants.
        """
    ...
    @participants.setter
    def participants(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RotationV2ParticipantGroupParticipantArgs']]]]):
        pulumi.set(self, "participants", value)


@pulumi.input_type
class RotationV2ParticipantGroupParticipantArgs:
    def __init__(__self__, *,
                 id: pulumi.Input[str],
...
@pulumi.input_type
class RotationV2ShiftTimeslotArgs:
    def __init__(__self__, *,
