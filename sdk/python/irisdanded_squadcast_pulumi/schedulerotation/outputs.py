...
__all__ = [
    'RotationV2ParticipantGroup',
    'RotationV2ParticipantGroupParticipant',
    'RotationV2ShiftTimeslot',
]

@pulumi.output_type
class RotationV2ParticipantGroup(dict):
    def __init__(__self__, *,
                 participants: Optional[Sequence['outputs.RotationV2ParticipantGroupParticipant']] = None):
        """
        :param Sequence['RotationV2ParticipantGroupParticipantArgs'] participants: Group participants.
        """
    ...
    @property
    @pulumi.getter
    def participants(self) -> Optional[Sequence['outputs.RotationV2ParticipantGroupParticipant']]:
        """
        Group participants.
        """
...
@pulumi.output_type
class RotationV2ParticipantGroupParticipant(dict):
    def __init__(__self__, *,
                 id: str,
                 type: str):
        """
...
@pulumi.output_type
class RotationV2ShiftTimeslot(dict):
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RotationV2ShiftTimeslot. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RotationV2ShiftTimeslot.__key_warning(key)
