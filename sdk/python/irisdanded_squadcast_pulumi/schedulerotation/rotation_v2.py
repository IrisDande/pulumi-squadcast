...
__all__ = ['RotationV2Args', 'RotationV2']

@pulumi.input_type
class RotationV2Args:
    def __init__(__self__, *,
                 ...
                 shift_timeslots: pulumi.Input[Sequence[pulumi.Input['RotationV2ShiftTimeslotArgs']]],
                 ...
                 participant_groups: Optional[pulumi.Input[Sequence[pulumi.Input['RotationV2ParticipantGroupArgs']]]] = None):
        """
        The set of arguments for constructing a RotationV2 resource.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RotationV2ShiftTimeslotArgs']]] shift_timeslots: Timeslots where the rotation is active.
        ...
        :param pulumi.Input[str] custom_period_unit: Unit of the custom rotation repeat pattern (day, week). Only applicable if period is set to custom.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RotationV2ParticipantGroupArgs']]] participant_groups: Ordered list of participant groups for the rotation. For each rotation the participant*groups are cycled through in order.
        """
    ...
    def shift_timeslots(self) -> pulumi.Input[Sequence[pulumi.Input['RotationV2ShiftTimeslotArgs']]]:
        """
    ...
    def shift_timeslots(self, value: pulumi.Input[Sequence[pulumi.Input['RotationV2ShiftTimeslotArgs']]]):
    ...
    def participant_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RotationV2ParticipantGroupArgs']]]]:
        """
    ...
    def participant_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RotationV2ParticipantGroupArgs']]]]):
        pulumi.set(self, "participant_groups", value)


@pulumi.input_type
class _RotationV2State:
    def __init__(__self__, *,
                 ...
                 shift_timeslots: Optional[pulumi.Input[Sequence[pulumi.Input['RotationV2ShiftTimeslotArgs']]]] = None,
                 start_date: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering RotationV2 resources.
        :param pulumi.Input[int] change_participants_frequency: Frequency with which participants change in the rotation.
        :param pulumi.Input[str] change_participants_unit: Unit of the frequency with which participants change in the rotation (rotation, day, week, month).
        :param pulumi.Input[int] custom_period_frequency: Frequency of the custom rotation repeat pattern. Only applicable if period is set to custom.
        :param pulumi.Input[str] custom_period_unit: Unit of the custom rotation repeat pattern (day, week). Only applicable if period is set to custom.
    ...
    @property
    @pulumi.getter(name="shiftTimeslots")
    def shift_timeslots(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RotationV2ShiftTimeslotArgs']]]]:
        """
        Timeslots where the rotation is active.
        """
        return pulumi.get(self, "shift_timeslots")
    ...
    @shift_timeslots.setter
    def shift_timeslots(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RotationV2ShiftTimeslotArgs']]]]):
        pulumi.set(self, "shift_timeslots", value)
...
class RotationV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 ends_after_iterations: Optional[pulumi.Input[int]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 participant_groups: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RotationV2ParticipantGroupArgs']]]]] = None,
                 period: Optional[pulumi.Input[str]] = None,
                 schedule_id: Optional[pulumi.Input[int]] = None,
                 shift_timeslots: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RotationV2ShiftTimeslotArgs']]]]] = None,
                 start_date: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        get_schedule = squadcast.Schedule.get_v2(name="Test Schedule",
            team_id=example_team.id)
        # Create a rotation with weekly period
        rotations_with_weekly_period = squadcast.schedule_rotation.RotationV2("rotationsWithWeeklyPeriod",
            schedule_id=get_schedule.id,
            start_date="2023-07-01T00:00:00Z",
            period="weekly",
            shift_timeslots=[squadcast.schedule_rotation.RotationV2ShiftTimeslotArgs(
                start_hour=10,
                start_minute=30,
                duration=720,
            )],
            ...
            participant_groups=[squadcast.schedule_rotation.RotationV2ParticipantGroupArgs(
                participants=[
                    squadcast.schedule_rotation.RotationV2ParticipantGroupParticipantArgs(
                        id=example_user.id,
                        type="user",
                    ),
                    squadcast.schedule_rotation.RotationV2ParticipantGroupParticipantArgs(
        ...
        rotations_with_custom_period = squadcast.schedule_rotation.RotationV2("rotationsWithCustomPeriod",
            schedule_id=get_schedule.id,
            start_date="2023-06-13T00:00:00Z",
            period="custom",
            shift_timeslots=[
                squadcast.schedule_rotation.RotationV2ShiftTimeslotArgs(
                    start_hour=10,
                    start_minute=0,
                    duration=1440,
            ...
            participant_groups=[
                squadcast.schedule_rotation.RotationV2ParticipantGroupArgs(
                    participants=[squadcast.schedule_rotation.RotationV2ParticipantGroupParticipantArgs(
                        id=example_user.id,
                        type="user",
                    )],
                ),
        ...
        ```sh
        $ pulumi import squadcast:ScheduleRotation/rotationV2:RotationV2 rotation "62d2fe23a57381088224d726:Example Schedule:Example Rotation"
        ```
        ...
        :param pulumi.Input[int] ends_after_iterations: Defines the number of iterations of the schedule rotation.
        :param pulumi.Input[str] name: Rotation name.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RotationV2ParticipantGroupArgs']]]] participant_groups: Ordered list of participant groups for the rotation. For each rotation the participant*groups are cycled through in order.
        :param pulumi.Input[str] period: Rotation period (none, daily, weekly, monthly, custom). Defines how often the rotation repeats.
        :param pulumi.Input[int] schedule_id: id of the schedule that the rotation belongs to.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RotationV2ShiftTimeslotArgs']]]] shift_timeslots: Timeslots where the rotation is active.
        :param pulumi.Input[str] start_date: Defines the start date of the rotation.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param RotationV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RotationV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RotationV2Args.__new__(RotationV2Args)
        ...
        super(RotationV2, __self__).__init__(
            'squadcast:ScheduleRotation/rotationV2:RotationV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            schedule_id: Optional[pulumi.Input[int]] = None,
            shift_timeslots: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RotationV2ShiftTimeslotArgs']]]]] = None,
            start_date: Optional[pulumi.Input[str]] = None) -> 'RotationV2':
        """
        Get an existing RotationV2 resource's state with the given name, id, and optional extra
        ...
        __props__ = _RotationV2State.__new__(_RotationV2State)
        ...
        __props__.__dict__["shift_timeslots"] = shift_timeslots
        __props__.__dict__["start_date"] = start_date
        return RotationV2(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="participantGroups")
    def participant_groups(self) -> pulumi.Output[Optional[Sequence['outputs.RotationV2ParticipantGroup']]]:
        """
        Ordered list of participant groups for the rotation. For each rotation the participant*groups are cycled through in order.
        """
        return pulumi.get(self, "participant_groups")
    ...
    @property
    @pulumi.getter(name="shiftTimeslots")
    def shift_timeslots(self) -> pulumi.Output[Sequence['outputs.RotationV2ShiftTimeslot']]:
        """
        Timeslots where the rotation is active.
        """
        return pulumi.get(self, "shift_timeslots")
