...
class ServiceArgs:
    def __init__(__self__, *,
                 ...
                 maintainer: pulumi.Input['ServiceMaintainerArgs'],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] alert_sources: List of active alert source names. Find all alert sources supported on Squadcast [here](https://www.squadcast.com/integrations).
    ...
    @property
    @pulumi.getter
    def maintainer(self) -> pulumi.Input['ServiceMaintainerArgs']:
        """
        Service owner.
        """
    ...
    @maintainer.setter
    def maintainer(self, value: pulumi.Input['ServiceMaintainerArgs']):
...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if maintainer is None and not opts.urn:
                raise TypeError("Missing required property 'maintainer'")
