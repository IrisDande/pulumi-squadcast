...
class MaintenanceArgs:
    def __init__(__self__, *,
                 ...
                 windows: Optional[pulumi.Input[Sequence[pulumi.Input['MaintenanceWindowArgs']]]] = None):
        """
        The set of arguments for constructing a Maintenance resource.
        :param pulumi.Input[str] service_id: Service id.
        :param pulumi.Input[Sequence[pulumi.Input['MaintenanceWindowArgs']]] windows: Date and Time range during which maintenance would be carried out
        """
    ...
    @property
    @pulumi.getter
    def windows(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MaintenanceWindowArgs']]]]:
        """
    ...
    @windows.setter
    def windows(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MaintenanceWindowArgs']]]]):
...
class Maintenance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 service_id: Optional[pulumi.Input[str]] = None,
                 windows: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MaintenanceWindowArgs']]]]] = None,
                 __props__=None):
        """
        ...
        example_service_maintenance = squadcast.service.Maintenance("exampleServiceMaintenance",
            service_id=example_service.id,
            windows=[
                squadcast.service.MaintenanceWindowArgs(
        ...
        :param pulumi.Input[str] service_id: Service id.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MaintenanceWindowArgs']]]] windows: Date and Time range during which maintenance would be carried out
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            service_id: Optional[pulumi.Input[str]] = None,
            windows: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MaintenanceWindowArgs']]]]] = None) -> 'Maintenance':
        """
    ...
    @property
    @pulumi.getter
    def windows(self) -> pulumi.Output[Optional[Sequence['outputs.MaintenanceWindow']]]:
        """
        Date and Time range during which maintenance would be carried out
        """
        return pulumi.get(self, "windows")
