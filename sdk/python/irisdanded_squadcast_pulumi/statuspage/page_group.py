...
__all__ = ['PageGroupArgs', 'PageGroup']
...
class PageGroupArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a PageGroup resource.
...
@pulumi.input_type
class _PageGroupState:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[str]] = None,
                 status_page_id: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering PageGroup resources.
        :param pulumi.Input[str] name: Name of the status page group.
        :param pulumi.Input[str] status_page_id: Id of the status page to which this group belongs to.
        """
        if name is not None:
...
class PageGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param PageGroupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PageGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PageGroupArgs.__new__(PageGroupArgs)
        ...
        super(PageGroup, __self__).__init__(
            'squadcast:StatusPage/pageGroup:PageGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[str]] = None,
            status_page_id: Optional[pulumi.Input[str]] = None) -> 'PageGroup':
        """
        ...
        __props__ = _PageGroupState.__new__(_PageGroupState)

        __props__.__dict__["name"] = name
        __props__.__dict__["status_page_id"] = status_page_id
        return PageGroup(resource_name, opts=opts, __props__=__props__)
