...
__all__ = [
    'RuleV2BasicExpression',
    'RuleV2Timeslot',
    'RuleV2TimeslotCustom',
]

@pulumi.output_type
class RuleV2BasicExpression(dict):
...
class RuleV2Timeslot(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RuleV2Timeslot. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RuleV2Timeslot.__key_warning(key)
    ...
    def __init__(__self__, *,
                 ...
                 start_time: str,
                 time_zone: str,
                 customs: Optional[Sequence['outputs.RuleV2TimeslotCustom']] = None,
        ...
        :param Sequence['RuleV2TimeslotCustomArgs'] customs: Use this field to specify the custom time slots for which this rule should be applied. This field is only applicable when the repetition field is set to custom.
    ...
    @property
    @pulumi.getter
    def customs(self) -> Optional[Sequence['outputs.RuleV2TimeslotCustom']]:
        """
...
@pulumi.output_type
class RuleV2TimeslotCustom(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "repeatsCount":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RuleV2TimeslotCustom. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RuleV2TimeslotCustom.__key_warning(key)
        return super().__getitem__(key)
