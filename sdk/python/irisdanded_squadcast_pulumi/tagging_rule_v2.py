...
__all__ = ['TaggingRuleV2Args', 'TaggingRuleV2']

@pulumi.input_type
class TaggingRuleV2Args:
    def __init__(__self__, *,
                 is_basic: pulumi.Input[bool],
                 service_id: pulumi.Input[str],
                 basic_expressions: Optional[pulumi.Input[Sequence[pulumi.Input['TaggingRuleV2BasicExpressionArgs']]]] = None,
                 expression: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['TaggingRuleV2TagArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['TaggingRuleV2BasicExpressionArgs']]] basic_expressions: The basic expression which needs to be evaluated to be true for this rule to apply.
        :param pulumi.Input[str] expression: The expression which needs to be evaluated to be true for this rule to apply.
        :param pulumi.Input[Sequence[pulumi.Input['TaggingRuleV2TagArgs']]] tags: The tags supposed to be set for a given payload(incident), Expression must be set when tags are empty and must contain addTags parameters.
        """
    ...
    def basic_expressions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['TaggingRuleV2BasicExpressionArgs']]]]:
        """
    ...
    def basic_expressions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['TaggingRuleV2BasicExpressionArgs']]]]):
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['TaggingRuleV2TagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['TaggingRuleV2TagArgs']]]]):
        pulumi.set(self, "tags", value)


@pulumi.input_type
class _TaggingRuleV2State:
    def __init__(__self__, *,
                 basic_expressions: Optional[pulumi.Input[Sequence[pulumi.Input['TaggingRuleV2BasicExpressionArgs']]]] = None,
                 expression: Optional[pulumi.Input[str]] = None,
...
class TaggingRuleV2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 basic_expressions: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TaggingRuleV2BasicExpressionArgs']]]]] = None,
                 expression: Optional[pulumi.Input[str]] = None,
                 is_basic: Optional[pulumi.Input[bool]] = None,
                 service_id: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TaggingRuleV2TagArgs']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TaggingRuleV2BasicExpressionArgs']]]] basic_expressions: The basic expression which needs to be evaluated to be true for this rule to apply.
        :param pulumi.Input[str] expression: The expression which needs to be evaluated to be true for this rule to apply.
        :param pulumi.Input[bool] is_basic: is_basic will be true when users use the drop down selectors which will have lhs, op & rhs value, whereas it will be false when they use the advanced mode and it would have the expression for it's value
        :param pulumi.Input[str] service_id: Service id.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TaggingRuleV2TagArgs']]]] tags: The tags supposed to be set for a given payload(incident), Expression must be set when tags are empty and must contain addTags parameters.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: TaggingRuleV2Args,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        [Tagging](https://support.squadcast.com/docs/event-tagging) is a rule-based, auto-tagging system with which you can define customised tags based on incident payloads, that get automatically assigned to incidents when they are triggered.
        ...
        :param str resource_name: The name of the resource.
        :param TaggingRuleV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TaggingRuleV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TaggingRuleV2Args.__new__(TaggingRuleV2Args)
        ...
        super(TaggingRuleV2, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            is_basic: Optional[pulumi.Input[bool]] = None,
            service_id: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['TaggingRuleV2TagArgs']]]]] = None) -> 'TaggingRuleV2':
        """
        ...
        __props__ = _TaggingRuleV2State.__new__(_TaggingRuleV2State)
        ...
        __props__.__dict__["service_id"] = service_id
        __props__.__dict__["tags"] = tags
        return TaggingRuleV2(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="basicExpressions")
    def basic_expressions(self) -> pulumi.Output[Optional[Sequence['outputs.TaggingRuleV2BasicExpression']]]:
        """
        The basic expression which needs to be evaluated to be true for this rule to apply.
        """
        return pulumi.get(self, "basic_expressions")
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Optional[Sequence['outputs.TaggingRuleV2Tag']]]:
        """
        The tags supposed to be set for a given payload(incident), Expression must be set when tags are empty and must contain addTags parameters.
        """
        return pulumi.get(self, "tags")
