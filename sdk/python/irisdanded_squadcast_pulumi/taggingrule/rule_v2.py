...
class RuleV2Args:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['RuleV2TagArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RuleV2TagArgs']]] tags: The tags supposed to be set for a given payload(incident), Expression must be set when tags are empty and must contain addTags parameters.
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RuleV2TagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RuleV2TagArgs']]]]):
...
class RuleV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 is_basic: Optional[pulumi.Input[bool]] = None,
                 service_id: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RuleV2TagArgs']]]]] = None,
                 __props__=None):
        """
        ...
        example_tagging_rule = squadcast.tagging_rule.RuleV2("exampleTaggingRule",
            service_id=example_service.id,
            is_basic=False,
            expression="payload[\\"event_id\\"] == 40",
            tags=[
                squadcast.tagging_rule.RuleV2TagArgs(
                    key="MyTag",
                    value="foo",
                    color="#ababab",
                ),
        ...
        example_basic_tagging_rule = squadcast.tagging_rule.RuleV2("exampleBasicTaggingRule",
            service_id=example_service.id,
            is_basic=True,
            basic_expressions=[squadcast.tagging_rule.RuleV2BasicExpressionArgs(
                lhs="payload[\\"foo\\"]",
                op="is",
                rhs="bar",
            )],
            tags=[squadcast.tagging_rule.RuleV2TagArgs(
                key="MyTag",
                value="foo",
                color="#ababab",
            )])
        # addTags must be set in expression when tags are not passed
        example_tagging_rules_resource_withouttags = squadcast.tagging_rule.RuleV2("exampleTaggingRulesResourceWithouttags",
            service_id=example_service.id,
            is_basic=False,
        ...
        :param pulumi.Input[bool] is_basic: is_basic will be true when users use the drop down selectors which will have lhs, op & rhs value, whereas it will be false when they use the advanced mode and it would have the expression for it's value
        :param pulumi.Input[str] service_id: Service id.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RuleV2TagArgs']]]] tags: The tags supposed to be set for a given payload(incident), Expression must be set when tags are empty and must contain addTags parameters.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        super(RuleV2, __self__).__init__(
            'squadcast:TaggingRule/ruleV2:RuleV2',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            is_basic: Optional[pulumi.Input[bool]] = None,
            service_id: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RuleV2TagArgs']]]]] = None) -> 'RuleV2':
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Optional[Sequence['outputs.RuleV2Tag']]]:
        """
        The tags supposed to be set for a given payload(incident), Expression must be set when tags are empty and must contain addTags parameters.
        """
        return pulumi.get(self, "tags")
