...
__all__ = ['ActionOrderingArgs', 'ActionOrdering']

@pulumi.input_type
class ActionOrderingArgs:
    def __init__(__self__, *,
                 action_orders: pulumi.Input[Sequence[pulumi.Input[int]]],
                 workflow_id: pulumi.Input[str]):
        """
        The set of arguments for constructing a ActionOrdering resource.
...
@pulumi.input_type
class _ActionOrderingState:
    def __init__(__self__, *,
                 action_orders: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
                 workflow_id: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering ActionOrdering resources.
        :param pulumi.Input[Sequence[pulumi.Input[int]]] action_orders: The order of actions in the workflow
        :param pulumi.Input[str] workflow_id: The ID of the workflow
        """
...
class ActionOrdering(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ActionOrderingArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ## Example Usage

        :param str resource_name: The name of the resource.
        :param ActionOrderingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ActionOrderingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ActionOrderingArgs.__new__(ActionOrderingArgs)
        ...
        super(ActionOrdering, __self__).__init__(
            'squadcast:WorkflowAction/actionOrdering:ActionOrdering',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            action_orders: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
            workflow_id: Optional[pulumi.Input[str]] = None) -> 'ActionOrdering':
        """
        ...
        __props__ = _ActionOrderingState.__new__(_ActionOrderingState)

        __props__.__dict__["action_orders"] = action_orders
        __props__.__dict__["workflow_id"] = workflow_id
        return ActionOrdering(resource_name, opts=opts, __props__=__props__)
